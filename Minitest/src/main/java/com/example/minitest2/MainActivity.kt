...
fun FirebaseUI(context: Context) {
    ...
    Column(
        ...
        Text(text = " Dữ liệu sản phẩm ", fontSize = 24.sp , fontWeight = FontWeight.Bold)
        ...
        Button(
            onClick = {
                ...
                if (TextUtils.isEmpty(courseName.value.toString())) {
                    ...
                    Toast.makeText(context, "Hay nhap loai san pham",
                        Toast.LENGTH_SHORT)
                        .show()
                } else if
                               (TextUtils.isEmpty(coursePrice.value.toString())) {
                    Toast.makeText(context, "Hay nhap gia san pham",
                        Toast.LENGTH_SHORT)
                        .show()
                } else if
                               (TextUtils.isEmpty(courseImage.value.toString())) {
                    Toast.makeText(context, "Hay nhap hinh anh san pham",
                        Toast.LENGTH_SHORT)
                        .show()
            ...
            Text(text = "Thêm sản phẩm", modifier = Modifier.padding(10.dp))
        }
        Spacer(modifier = Modifier.height(10.dp))
